...
const Cart = () => {
  ...
  return (
    <div className="min-h-screen bg-royal-black pt-32 pb-24 px-6 md:px-12 font-sans text-white">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="lg:w-2/3 space-y-4">
            ...
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="bg-white/5 border border-white/10 p-4 md:p-6 rounded-sm flex flex-col md:flex-row gap-6 relative"
              >
                {/* Image */}
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-2">
                    ...
                    <button
                      ...
                      className="text-white font-medium text-sm hover:text-red-500 uppercase"
                    >
                      Remove
                    </button>
                    <button
                      onClick={() => saveForLater(item)}
                      className="text-white font-medium text-sm hover:text-royal-gold uppercase"
                    >
                      Save for Later
                    </button>
                  </div>
            ...
            <div className="bg-white/5 border border-white/10 p-4 rounded-sm flex items-center justify-between shadow-lg">
              ...
              <button className="text-royal-gold text-sm font-bold uppercase">
                Add
              </button>
            </div>
          </div>
          ...
          <div className="lg:w-1/3">
            <div className="bg-white/5 border border-white/10 rounded-sm p-6 sticky top-28 h-fit">
              <h3 className="text-gray-400 uppercase font-bold text-sm tracking-widest border-b border-white/10 pb-4 mb-4">
                Price Details
              </h3>
              ...
              <Button
                onClick={() => navigate("/checkout")}
                variant="primary"
                className="w-full py-4 text-sm font-bold tracking-widest bg-royal-gold text-black hover:bg-white shadow-[0_0_15px_rgba(212,175,55,0.3)]"
              >
                PLACE ORDER
              </Button>
            </div>
