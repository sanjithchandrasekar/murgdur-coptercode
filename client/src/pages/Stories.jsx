...
const Stories = () => {
  ...
  const stories = data?.stories || [
    {
      image:
        "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?q=80&w=2274&auto=format&fit=crop",
      category: "Heritage",
    ...
    {
      image:
        "https://images.unsplash.com/photo-1540221652346-e5dd6b50f3e7?q=80&w=2069&auto=format&fit=crop",
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      <SEO
        ...
        description="Explore the rich narratives, craftsmanship, and heritage of House of Murgdur."
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {stories.map((story, idx) => (
            <div key={idx} className="group cursor-pointer">
              ...
              <span className="text-xs font-bold text-royal-gold uppercase tracking-widest mb-2 block">
                {story.category}
              </span>
              <h2 className="text-3xl font-serif text-white group-hover:text-royal-gold transition-colors mb-4">
                {story.title}
              </h2>
