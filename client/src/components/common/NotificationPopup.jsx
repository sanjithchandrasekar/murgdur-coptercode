        ...
        <div className="fixed inset-0 z-[150] flex items-center justify-center px-4">
          ...
          >
            ...
            <div className="flex flex-col items-center text-center">
              {/* Status Icon */}
              <div
                className={`w-12 h-12 rounded-full border flex items-center justify-center mb-4 ${notification.status === "info" ? "border-blue-400 bg-blue-900/20" : "border-royal-gold bg-royal-gold/10"}`}
              >
              ...
              <div
                className={`w-16 h-px mb-6 ${notification.status === "info" ? "bg-blue-400/50" : "bg-royal-gold/50"}`}
              ></div>
