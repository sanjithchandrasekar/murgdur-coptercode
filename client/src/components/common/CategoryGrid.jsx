    ...
    <section className="py-24 px-4 bg-royal-black">
      <div className="container mx-auto">
        <div className="flex justify-between items-end mb-12">
          ...
          <Link
            to="/shop"
            className="text-royal-gold flex items-center gap-2 hover:underline underline-offset-4 transition-all"
          >
          ...
          {categories.map((cat, idx) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-6 w-full">
                ...
                <span className="text-royal-gold text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  Shop Now
                </span>
              </div>
            </Link>
