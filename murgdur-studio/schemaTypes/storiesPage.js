export default {
    ...
    fields: [
        ...
        { name: 'subheading', title: 'Subheading (visible below eyebrow)', type: 'string', group: 'main', initialValue: 'Craft, culture, and the timeless pursuit of excellence — told through stories.' },
