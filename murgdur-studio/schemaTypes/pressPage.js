export default {
    ...
    fields: [
        ...
        { name: 'featuredInHeading', title: '"As Featured In" Heading', type: 'string', group: 'main', initialValue: 'As Featured In' },
        {
            name: 'featuredInOutlets',
            title: '"As Featured In" Media Outlets',
            type: 'array',
            group: 'main',
            description: 'List of media outlet names shown in the "As Featured In" bar',
            of: [{ type: 'string' }]
        },
