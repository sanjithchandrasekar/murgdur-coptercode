export default {
    ...
    fields: [
        ...
        { name: 'founderBio', title: 'Founder Biography (Paragraph 1)', type: 'text', rows: 5, group: 'founder' },
        { name: 'founderBio2', title: 'Founder Biography (Paragraph 2)', type: 'text', rows: 4, group: 'founder' },
        { name: 'founderBio3', title: 'Founder Biography (Paragraph 3)', type: 'text', rows: 4, group: 'founder' },
